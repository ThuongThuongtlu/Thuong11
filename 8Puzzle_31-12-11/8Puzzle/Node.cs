...
namespace _8Puzzle
{
    ...
    class Node
    {
        ...
        public const int BlankValue = 0; //giá trị trống
        MoveDirection Direction; //Hướng di chuyển
        Goal goal;
        int id;
        int h, f, g;
        int[,] arrNode;
        ...
        //{
        //    FileStream fin = new FileStream("C:\\Users\\Thuong\\Desktop\\8Puzzle_11-2-2018", FileMode.Open);
        //    StreamReader read = new StreamReader(fin, Encoding.UTF8);
        //    Size = read.ReadLine();// ReadLine() chỉ đọc 1 dòng đầu thoy, ReadToEnd là đọc hết
